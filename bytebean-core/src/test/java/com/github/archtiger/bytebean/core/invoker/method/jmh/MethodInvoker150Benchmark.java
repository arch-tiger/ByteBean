...
public class MethodInvoker150Benchmark {
    ...
    public void setup() throws Throwable {
        ...
        methodHandleInvoker = MethodHandleInvoker.of(Field150Entity.class);
        ...
        for (int i = 1; i <= TEST_COUNT; i++) {
            ...
            Method getter = Field150Entity.class.getMethod(getterName);
            Method setter = Field150Entity.class.getMethod(setterName, Integer.class);
...
public void test_MethodHandle_Setter() throws Throwable {
    ...
    public static void main(String[] args) throws Exception {
        org.openjdk.jmh.Main.main(new String[]{MethodInvoker150Benchmark.class.getName()});
    }
}
