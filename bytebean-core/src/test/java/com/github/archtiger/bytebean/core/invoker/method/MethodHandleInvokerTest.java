...
class MethodHandleInvokerTest {
    ...
    void testIndexOutOfBoundsInvoke() {
        assertThrows(IllegalArgumentException.class, () -> {
            methodHandleInvoker.invoke(-1, entity);
        });

        assertThrows(IllegalArgumentException.class, () -> {
            methodHandleInvoker.invoke(1000, entity);
        });

        assertThrows(IllegalArgumentException.class, () -> {
            methodHandleInvoker.invoke(Integer.MIN_VALUE, entity);
        });

        assertThrows(IllegalArgumentException.class, () -> {
            methodHandleInvoker.invoke(Integer.MAX_VALUE, entity);
        });
    }
    ...
    void testIndexOutOfBoundsIntInvoke() {
        assertThrows(IllegalArgumentException.class, () -> {
            methodHandleInvoker.intInvoke(-1, entity);
        });

        assertThrows(IllegalArgumentException.class, () -> {
            methodHandleInvoker.intInvoke(1000, entity);
        });
    }

    @Test
    void testIndexOutOfBoundsAllPrimitiveInvokes() {
        assertThrows(IllegalArgumentException.class, () -> methodHandleInvoker.longInvoke(-1, entity));
        assertThrows(IllegalArgumentException.class, () -> methodHandleInvoker.floatInvoke(-1, entity));
        assertThrows(IllegalArgumentException.class, () -> methodHandleInvoker.doubleInvoke(-1, entity));
        assertThrows(IllegalArgumentException.class, () -> methodHandleInvoker.booleanInvoke(-1, entity));
        assertThrows(IllegalArgumentException.class, () -> methodHandleInvoker.byteInvoke(-1, entity));
        assertThrows(IllegalArgumentException.class, () -> methodHandleInvoker.shortInvoke(-1, entity));
        assertThrows(IllegalArgumentException.class, () -> methodHandleInvoker.charInvoke(-1, entity));

        assertThrows(IllegalArgumentException.class, () -> methodHandleInvoker.longInvoke(1000, entity));
        assertThrows(IllegalArgumentException.class, () -> methodHandleInvoker.floatInvoke(1000, entity));
        assertThrows(IllegalArgumentException.class, () -> methodHandleInvoker.doubleInvoke(1000, entity));
        assertThrows(IllegalArgumentException.class, () -> methodHandleInvoker.booleanInvoke(1000, entity));
        assertThrows(IllegalArgumentException.class, () -> methodHandleInvoker.byteInvoke(1000, entity));
        assertThrows(IllegalArgumentException.class, () -> methodHandleInvoker.shortInvoke(1000, entity));
        assertThrows(IllegalArgumentException.class, () -> methodHandleInvoker.charInvoke(1000, entity));
    }

    @Test
    void testIndexOutOfBoundsPrimitive1Invokes() {
        assertThrows(IllegalArgumentException.class, () -> methodHandleInvoker.invokeInt1(-1, entity, 1));
        assertThrows(IllegalArgumentException.class, () -> methodHandleInvoker.invokeLong1(-1, entity, 1L));
        assertThrows(IllegalArgumentException.class, () -> methodHandleInvoker.invokeFloat1(-1, entity, 1.0f));
        assertThrows(IllegalArgumentException.class, () -> methodHandleInvoker.invokeDouble1(-1, entity, 1.0));
        assertThrows(IllegalArgumentException.class, () -> methodHandleInvoker.invokeBoolean1(-1, entity, true));
        assertThrows(IllegalArgumentException.class, () -> methodHandleInvoker.invokeByte1(-1, entity, (byte) 1));
        assertThrows(IllegalArgumentException.class, () -> methodHandleInvoker.invokeShort1(-1, entity, (short) 1));
        assertThrows(IllegalArgumentException.class, () -> methodHandleInvoker.invokeChar1(-1, entity, 'A'));

        assertThrows(IllegalArgumentException.class, () -> methodHandleInvoker.invokeInt1(1000, entity, 1));
        assertThrows(IllegalArgumentException.class, () -> methodHandleInvoker.invokeLong1(1000, entity, 1L));
        assertThrows(IllegalArgumentException.class, () -> methodHandleInvoker.invokeFloat1(1000, entity, 1.0f));
        assertThrows(IllegalArgumentException.class, () -> methodHandleInvoker.invokeDouble1(1000, entity, 1.0));
        assertThrows(IllegalArgumentException.class, () -> methodHandleInvoker.invokeBoolean1(1000, entity, true));
        assertThrows(IllegalArgumentException.class, () -> methodHandleInvoker.invokeByte1(1000, entity, (byte) 1));
        assertThrows(IllegalArgumentException.class, () -> methodHandleInvoker.invokeShort1(1000, entity, (short) 1));
        assertThrows(IllegalArgumentException.class, () -> methodHandleInvoker.invokeChar1(1000, entity, 'A'));
    }
    ...
    void testNullInstance() {
        ...
        assertThrows(NullPointerException.class, () -> {
            methodHandleInvoker.invoke(getIntIndex, null);
        });

        assertThrows(NullPointerException.class, () -> {
            methodHandleInvoker.invoke1(setIntIndex, null, 100);
        });

        assertThrows(NullPointerException.class, () -> {
            methodHandleInvoker.intInvoke(getIntIndex, null);
        });

        assertThrows(NullPointerException.class, () -> {
            methodHandleInvoker.invokeInt1(setIntIndex, null, 100);
        });
    ...
    void testNullInstanceAllPrimitiveInvokes() {
        ...
        assertThrows(NullPointerException.class, () -> methodHandleInvoker.longInvoke(getLongIndex, null));
        assertThrows(NullPointerException.class, () -> methodHandleInvoker.floatInvoke(getFloatIndex, null));
        assertThrows(NullPointerException.class, () -> methodHandleInvoker.doubleInvoke(getDoubleIndex, null));
        assertThrows(NullPointerException.class, () -> methodHandleInvoker.booleanInvoke(getBooleanIndex, null));
        assertThrows(NullPointerException.class, () -> methodHandleInvoker.byteInvoke(getByteIndex, null));
        assertThrows(NullPointerException.class, () -> methodHandleInvoker.shortInvoke(getShortIndex, null));
        assertThrows(NullPointerException.class, () -> methodHandleInvoker.charInvoke(getCharIndex, null));
    }
    ...
    void testNullArrayInVarargsInvoke() {
        ...
        assertThrows(NullPointerException.class, () -> {
            methodHandleInvoker.invoke(setStringIndex, entity, (Object[]) null);
        });
    }
    ...
    void testNullArgumentsForPrimitiveParams() {
        ...
        assertThrows(NullPointerException.class, () -> {
            methodHandleInvoker.invoke(setIntIndex, entity, new Object[]{null});
        });

        assertThrows(NullPointerException.class, () -> {
            methodHandleInvoker.invoke(setLongIndex, entity, new Object[]{null});
        });

        assertThrows(NullPointerException.class, () -> {
            methodHandleInvoker.invoke(setFloatIndex, entity, new Object[]{null});
        });

        assertThrows(NullPointerException.class, () -> {
            methodHandleInvoker.invoke(setDoubleIndex, entity, new Object[]{null});
        });

        assertThrows(NullPointerException.class, () -> {
            methodHandleInvoker.invoke(setBooleanIndex, entity, new Object[]{null});
        });

        assertThrows(NullPointerException.class, () -> {
            methodHandleInvoker.invoke(setByteIndex, entity, new Object[]{null});
        });

        assertThrows(NullPointerException.class, () -> {
            methodHandleInvoker.invoke(setShortIndex, entity, new Object[]{null});
        });

        assertThrows(NullPointerException.class, () -> {
            methodHandleInvoker.invoke(setCharIndex, entity, new Object[]{null});
        });
    }
    ...
    void testNullArgumentForPrimitiveParamsSingleArgInvoke() {
        ...
        assertThrows(NullPointerException.class, () -> {
            methodHandleInvoker.invoke1(setIntIndex, entity, (Object) null);
        });

        assertThrows(NullPointerException.class, () -> {
            methodHandleInvoker.invoke1(setLongIndex, entity, (Object) null);
        });

        assertThrows(NullPointerException.class, () -> {
            methodHandleInvoker.invoke1(setFloatIndex, entity, (Object) null);
        });

        assertThrows(NullPointerException.class, () -> {
            methodHandleInvoker.invoke1(setDoubleIndex, entity, (Object) null);
        });
    }
    ...
    void testWrongArgumentTypeForInt() {
        ...
        assertThrows(ClassCastException.class, () -> {
            methodHandleInvoker.invoke(setIntIndex, entity, new Object[]{"not a number"});
        });

        // int参数不能接收long - 会抛出ClassCastException
        assertThrows(ClassCastException.class, () -> {
            methodHandleInvoker.invoke(setIntIndex, entity, new Object[]{100L});
        });

        // int参数不能接收double - 会抛出ClassCastException
        assertThrows(ClassCastException.class, () -> {
            methodHandleInvoker.invoke(setIntIndex, entity, new Object[]{1.5});
        });

        // int参数不能接收boolean - 会抛出ClassCastException
        assertThrows(ClassCastException.class, () -> {
            methodHandleInvoker.invoke(setIntIndex, entity, new Object[]{true});
        });

        // 正确的int类型应该工作
        methodHandleInvoker.invoke(setIntIndex, entity, new Object[]{42});
        assertEquals(42, ((Integer) methodHandleInvoker.invoke(addIntIndex, entity, new Object[]{0})).intValue());
    }
    ...
    void testWrongArgumentTypeForLong() {
        ...
        assertThrows(ClassCastException.class, () -> {
            methodHandleInvoker.invoke(setLongIndex, entity, new Object[]{"not a number"});
        });

        assertThrows(ClassCastException.class, () -> {
            methodHandleInvoker.invoke(setLongIndex, entity, new Object[]{1.5});
        });

        assertThrows(ClassCastException.class, () -> {
            methodHandleInvoker.invoke(setLongIndex, entity, new Object[]{true});
        });

        // 正确的long类型应该工作
        methodHandleInvoker.invoke(setLongIndex, entity, new Object[]{1000L});
        assertEquals(1000L, ((Long) methodHandleInvoker.invoke(addLongIndex, entity, new Object[]{0L})).longValue());
    }
    ...
    void testWrongArgumentTypeForFloat() {
        ...
        assertThrows(ClassCastException.class, () -> {
            methodHandleInvoker.invoke(setFloatIndex, entity, new Object[]{"not a number"});
        });

        assertThrows(ClassCastException.class, () -> {
            methodHandleInvoker.invoke(setFloatIndex, entity, new Object[]{true});
        });

        // 正确的float类型应该工作
        methodHandleInvoker.invoke(setFloatIndex, entity, new Object[]{3.14f});
        assertEquals(3.14f, ((Float) methodHandleInvoker.invoke(methodInvokerHelper.getMethodIndex("getFloat"), entity)).floatValue(), 0.0001f);
    }
    ...
    void testWrongArgumentTypeForDouble() {
        ...
        assertThrows(ClassCastException.class, () -> {
            methodHandleInvoker.invoke(setDoubleIndex, entity, new Object[]{"not a number"});
        });

        assertThrows(ClassCastException.class, () -> {
            methodHandleInvoker.invoke(setDoubleIndex, entity, new Object[]{true});
        });

        // 正确的double类型应该工作
        methodHandleInvoker.invoke(setDoubleIndex, entity, new Object[]{2.71828});
        assertEquals(2.71828, ((Double) methodHandleInvoker.invoke(methodInvokerHelper.getMethodIndex("getDouble"), entity)).doubleValue(), 0.000001);
    }
    ...
    void testWrongArgumentTypeForBoolean() {
        ...
        assertThrows(ClassCastException.class, () -> {
            methodHandleInvoker.invoke(setBooleanIndex, entity, new Object[]{"not a boolean"});
        });

        assertThrows(ClassCastException.class, () -> {
            methodHandleInvoker.invoke(setBooleanIndex, entity, new Object[]{1});
        });

        assertThrows(ClassCastException.class, () -> {
            methodHandleInvoker.invoke(setBooleanIndex, entity, new Object[]{1.0});
        });

        // 正确的boolean类型应该工作
        methodHandleInvoker.invoke(setBooleanIndex, entity, new Object[]{true});
        assertEquals(true, methodHandleInvoker.invoke(methodInvokerHelper.getMethodIndex("getBoolean"), entity));
    }
    ...
    void testWrongArgumentTypeForByte() {
        ...
        assertThrows(ClassCastException.class, () -> {
            methodHandleInvoker.invoke(setByteIndex, entity, new Object[]{"not a number"});
        });

        assertThrows(ClassCastException.class, () -> {
            methodHandleInvoker.invoke(setByteIndex, entity, new Object[]{true});
        });

        // 正确的byte类型应该工作
        methodHandleInvoker.invoke(setByteIndex, entity, new Object[]{(byte) 42});
        assertEquals((byte) 42, ((Byte) methodHandleInvoker.invoke(methodInvokerHelper.getMethodIndex("getByte"), entity)).byteValue());
    }
    ...
    void testWrongArgumentTypeForShort() {
        ...
        assertThrows(ClassCastException.class, () -> {
            methodHandleInvoker.invoke(setShortIndex, entity, new Object[]{"not a number"});
        });

        assertThrows(ClassCastException.class, () -> {
            methodHandleInvoker.invoke(setShortIndex, entity, new Object[]{true});
        });

        // 正确的short类型应该工作
        methodHandleInvoker.invoke(setShortIndex, entity, new Object[]{(short) 123});
        assertEquals((short) 123, ((Short) methodHandleInvoker.invoke(methodInvokerHelper.getMethodIndex("getShort"), entity)).shortValue());
    }
    ...
    void testWrongArgumentTypeForChar() {
        ...
        assertThrows(ClassCastException.class, () -> {
            methodHandleInvoker.invoke(setCharIndex, entity, new Object[]{"not a char"});
        });

        assertThrows(ClassCastException.class, () -> {
            methodHandleInvoker.invoke(setCharIndex, entity, new Object[]{65});
        });

        assertThrows(ClassCastException.class, () -> {
            methodHandleInvoker.invoke(setCharIndex, entity, new Object[]{true});
        });

        // 正确的char类型应该工作
        methodHandleInvoker.invoke(setCharIndex, entity, new Object[]{'A'});
        assertEquals('A', ((Character) methodHandleInvoker.invoke(methodInvokerHelper.getMethodIndex("getChar"), entity)).charValue());
    }
    ...
    void testWrongArgumentTypeForString() {
        ...
        assertThrows(ClassCastException.class, () -> {
            methodHandleInvoker.invoke(setStringIndex, entity, new Object[]{123});
        });

        assertThrows(ClassCastException.class, () -> {
            methodHandleInvoker.invoke(setStringIndex, entity, new Object[]{true});
        });

        // 正确的String类型应该工作
        methodHandleInvoker.invoke(setStringIndex, entity, new Object[]{"test"});
        assertEquals("test", methodHandleInvoker.invoke(methodInvokerHelper.getMethodIndex("getString"), entity));
    }
    ...
    void testMixedWrongArgumentTypes() {
        ...
        // 多参数方法中部分参数类型错误
        assertThrows(ClassCastException.class, () -> {
            methodHandleInvoker.invoke(addTwoIntsIndex, entity, new Object[]{10, "20"});
        });
        ...
        assertThrows(ClassCastException.class, () -> {
            methodHandleInvoker.invoke(addThreeDoublesIndex, entity, new Object[]{1.0, 2.0, "3.0"});
        });

        assertThrows(ClassCastException.class, () -> {
            methodHandleInvoker.invoke(concatenateIndex, entity, new Object[]{"a", 123});
        });
        ...
        result = methodHandleInvoker.invoke(concatenateIndex, entity, new Object[]{"hello", "world"});
        assertEquals("helloworld", result);
    }
