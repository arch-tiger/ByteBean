...
public class MethodInvoker500ManyParameterBenchmark {
    ...
    public void setup() throws Throwable {
        ...
        reflectionSetter = Field500Entity.class.getMethod(methodName,
    ...
    public static void main(String[] args) throws Exception {
        org.openjdk.jmh.Main.main(new String[]{MethodInvoker500ManyParameterBenchmark.class.getName()});
    }
}
