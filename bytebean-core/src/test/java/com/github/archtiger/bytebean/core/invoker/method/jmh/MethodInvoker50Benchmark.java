...
public class MethodInvoker50Benchmark {
    ...
    public void setup() throws Throwable {
        ...
        // 初始化 ReflectASM
        reflectasmMethodAccess = MethodAccess.get(Field50Entity.class);
        reflectasmGetterIndexes = new ArrayList<>(TEST_COUNT);
        reflectasmSetterIndexes = new ArrayList<>(TEST_COUNT);
        
        // 初始化 MethodInvokerHelper
        methodInvokerHelper = MethodInvokerHelper.of(Field50Entity.class);
        ...
        methodHandleInvoker = MethodHandleInvoker.of(Field50Entity.class);
        ...
        for (int i = 1; i <= TEST_COUNT; i++) {
            ...
            Method getter = Field50Entity.class.getMethod(getterName);
            Method setter = Field50Entity.class.getMethod(setterName, Integer.class);
    ...
    public static void main(String[] args) throws Exception {
        org.openjdk.jmh.Main.main(new String[]{MethodInvoker50Benchmark.class.getName()});
    }
}
