...
public class MethodInvoker100ManyParameterBenchmark {
    ...
    public void setup() throws Throwable {
        ...
        reflectionSetter = Field100Entity.class.getMethod(methodName,
    ...
    public static void main(String[] args) throws Exception {
        org.openjdk.jmh.Main.main(new String[]{MethodInvoker100ManyParameterBenchmark.class.getName()});
    }
}
