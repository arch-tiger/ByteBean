...
public class MethodInvoker10Benchmark {
    ...
    public void setup() throws Throwable {
        ...
        methodHandleInvoker = MethodHandleInvoker.of(Field10Entity.class);
        ...
        for (int i = 1; i <= TEST_COUNT; i++) {
            ...
            Method getter = Field10Entity.class.getMethod(getterName);
            Method setter = Field10Entity.class.getMethod(setterName, Integer.class);
    ...
    public static void main(String[] args) throws Exception {
        org.openjdk.jmh.Main.main(new String[]{MethodInvoker10Benchmark.class.getName()});
    }
}
