...
public class MethodInvoker300ManyParameterBenchmark {
    ...
    public void setup() throws Throwable {
        ...
        // 使用第一个5参数方法进行测试
        String methodName = "setFiveFields_1_5";

        // 获取反射方法 - 参数类型为 5个 Integer.class
        reflectionSetter = Field300Entity.class.getMethod(methodName,
    ...
    public static void main(String[] args) throws Exception {
        org.openjdk.jmh.Main.main(new String[]{MethodInvoker300ManyParameterBenchmark.class.getName()});
    }
}
