...
public class MethodInvoker50ManyParameterBenchmark {
    ...
    public void setup() throws Throwable {
        ...
        reflectionSetter = Field50Entity.class.getMethod(methodName,
    ...
    public static void main(String[] args) throws Exception {
        org.openjdk.jmh.Main.main(new String[]{MethodInvoker50ManyParameterBenchmark.class.getName()});
    }
}
