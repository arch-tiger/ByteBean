...
public class MethodInvoker1000ManyParameterBenchmark {
    ...
    public void setup() throws Throwable {
        ...
        reflectionSetter = Field1000Entity.class.getMethod(methodName,
    ...
    public static void main(String[] args) throws Exception {
        org.openjdk.jmh.Main.main(new String[]{MethodInvoker1000ManyParameterBenchmark.class.getName()});
    }
}
