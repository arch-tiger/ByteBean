...
public class MethodInvoker200ManyParameterBenchmark {
    ...
    public void setup() throws Throwable {
        ...
        reflectionSetter = Field200Entity.class.getMethod(methodName,
    ...
    public static void main(String[] args) throws Exception {
        org.openjdk.jmh.Main.main(new String[]{MethodInvoker200ManyParameterBenchmark.class.getName()});
    }
}
