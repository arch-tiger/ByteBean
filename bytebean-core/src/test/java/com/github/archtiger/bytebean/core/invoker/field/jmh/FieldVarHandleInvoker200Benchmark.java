...
public class FieldVarHandleInvoker200Benchmark {
    ...
    public void setup() throws Exception {
        ...
        standardReflectionField = Field200Entity.class.getDeclaredField("field100");
        standardReflectionField.setAccessible(true);

        reflectasmAccess = FieldAccess.get(Field200Entity.class);
        reflectasmFieldIndex = reflectasmAccess.getIndex("field100");
        reflectasmFirstFieldIndex = reflectasmAccess.getIndex("field1");
        reflectasmMiddleFieldIndex = reflectasmAccess.getIndex("field100");
        reflectasmLastFieldIndex = reflectasmAccess.getIndex("field200");

        varHandleInvoker = FieldVarHandleInvoker.of(Field200Entity.class);
        fieldInvokerHelper = FieldInvokerHelper.of(Field200Entity.class);
        fieldInvokerFieldIndex = fieldInvokerHelper.getFieldGetterIndex("field100");
        fieldInvokerFirstFieldIndex = fieldInvokerHelper.getFieldGetterIndex("field1");
        fieldInvokerMiddleFieldIndex = fieldInvokerHelper.getFieldGetterIndex("field100");
        fieldInvokerLastFieldIndex = fieldInvokerHelper.getFieldGetterIndex("field200");
    ...
    public void reflectUtilGetMultipleFields() throws IllegalAccessException {
        ReflectUtil.getFieldValue(entity, "field100");
        ReflectUtil.setFieldValue(entity, "field100", 1);
        ReflectUtil.getFieldValue(entity, "field100");
        ReflectUtil.setFieldValue(entity, "field100", 2);
        ReflectUtil.getFieldValue(entity, "field100");
        ReflectUtil.setFieldValue(entity, "field100", 3);
        ReflectUtil.getFieldValue(entity, "field100");
        ReflectUtil.setFieldValue(entity, "field100", 4);
        ReflectUtil.getFieldValue(entity, "field100");
        ReflectUtil.setFieldValue(entity, "field100", 5);
    }
    ...
    public Object reflectUtilGet() {
        return ReflectUtil.getFieldValue(entity, "field100");
    }

    @Benchmark
    public void reflectUtilSet() {
        ReflectUtil.setFieldValue(entity, "field100", 999);
    }
    ...
    public Object reflectUtilMixedOperations() {
        ReflectUtil.setFieldValue(entity, "field100", 100);
        Object result = ReflectUtil.getFieldValue(entity, "field100");
        ReflectUtil.setFieldValue(entity, "field100", 200);
        return ReflectUtil.getFieldValue(entity, "field100");
    }
