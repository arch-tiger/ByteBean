...
public class MethodInvoker100Benchmark {
    ...
    public void setup() throws Throwable {
        ...
        // 初始化 ReflectASM
        reflectasmMethodAccess = MethodAccess.get(Field100Entity.class);
        ...
        for (int i = 1; i <= TEST_COUNT; i++) {
            ...
            Method getter = Field100Entity.class.getMethod(getterName);
            Method setter = Field100Entity.class.getMethod(setterName, Integer.class);
    ...
    public static void main(String[] args) throws Exception {
        org.openjdk.jmh.Main.main(new String[]{MethodInvoker100Benchmark.class.getName()});
    }
}
