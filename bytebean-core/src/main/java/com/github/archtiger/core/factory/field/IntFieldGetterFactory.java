 ...
 * @datetime 2026/1/8
 */
public final class IntFieldGetterFactory extends AbstractInvokerFactory<IntFieldGetter> {
    private final Field targetField;

    public IntFieldGetterFactory(Class<?> targetClass, Field targetField) {
        super(targetClass);
