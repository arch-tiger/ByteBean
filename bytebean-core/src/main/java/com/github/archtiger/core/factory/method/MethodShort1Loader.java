...
public final class MethodShort1Loader extends AbstractInvokerLoader<MethodShort1> {
    ...
    @Override
    protected Class<MethodShort1> getInvokerClass() {
    ...
    protected ByteCodeAppender getByteCodeAppender() {
        return new MethodPrimitive1InvokerAppender(new InvokerInfo(getTargetClass(), getInvokerClass(), short.class), targetMethod);
    }
