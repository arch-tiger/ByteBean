...
import com.github.archtiger.definition.invoker.method.BooleanMethod;
 ...
 * @datetime 2026/1/9
 */
public final class BooleanMethodLoader extends AbstractInvokerLoader<BooleanMethod> {
    private final Method targetMethod;

    public BooleanMethodLoader(Class<?> targetClass, Method targetMethod) {
        super(targetClass);
        this.targetMethod = targetMethod;
    }

    @Override
    protected Class<BooleanMethod> defineInvokerClass() {
        return BooleanMethod.class;
    }

    @Override
    protected InvokerNameInfo defineInvokerName() {
        return InvokerNameInfo.forMethod(getTargetClass(), targetMethod, BooleanMethod.class);
    }
