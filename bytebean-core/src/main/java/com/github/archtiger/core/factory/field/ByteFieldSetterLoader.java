 ...
 * @datetime 2026/1/8
 */
public final class ByteFieldSetterLoader extends AbstractInvokerLoader<ByteFieldSetter> {
    private final Field targetField;

    public ByteFieldSetterLoader(Class<?> targetClass, Field targetField) {
        super(targetClass);
        this.targetField = targetField;
    }

    @Override
    protected Class<ByteFieldSetter> getInvokerClass() {
