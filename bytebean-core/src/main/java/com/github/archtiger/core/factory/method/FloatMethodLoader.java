...
import com.github.archtiger.definition.invoker.method.FloatMethod;
 ...
 * @datetime 2026/1/9
 */
public final class FloatMethodLoader extends AbstractInvokerLoader<FloatMethod> {
    private final Method targetMethod;

    public FloatMethodLoader(Class<?> targetClass, Method targetMethod) {
        super(targetClass);
