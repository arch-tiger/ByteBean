 ...
 * @datetime 2026/1/8
 */
public final class DoubleFieldSetterLoader extends AbstractInvokerLoader<DoubleFieldSetter> {
    private final Field targetField;

    public DoubleFieldSetterLoader(Class<?> targetClass, Field targetField) {
        super(targetClass);
