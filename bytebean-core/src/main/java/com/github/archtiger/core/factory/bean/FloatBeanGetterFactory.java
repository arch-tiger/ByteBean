...
import com.github.archtiger.core.invoke.bean.FloatBeanGetter;
 ...
 * @datetime 2026/1/7
 */
public final class FloatBeanGetterFactory extends AbstractInvokerFactory<FloatBeanGetter> {
    private final Method targetMethod;

    public FloatBeanGetterFactory(Class<?> targetClass, Method targetMethod) {
        super(targetClass);
        this.targetMethod = targetMethod;
    }

    @Override
    protected Class<FloatBeanGetter> defineInvokerClass() {
        return FloatBeanGetter.class;
    }

    @Override
    protected InvokerNameInfo defineInvokerName() {
        return InvokerNameInfo.forMethod(getTargetClass(), targetMethod, FloatBeanGetter.class);
    }
