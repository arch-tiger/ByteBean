...
import com.github.archtiger.core.invoke.bean.CharBeanSetter;
 ...
 * @datetime 2026/1/7
 */
public final class CharBeanSetterFactory extends AbstractInvokerFactory<CharBeanSetter> {
    private final Method targetMethod;

    public CharBeanSetterFactory(Class<?> targetClass, Method targetMethod) {
        super(targetClass);
        this.targetMethod = targetMethod;
    }

    @Override
    protected Class<CharBeanSetter> defineInvokerClass() {
        return CharBeanSetter.class;
    }

    @Override
    protected InvokerNameInfo defineInvokerName() {
        return InvokerNameInfo.forMethod(getTargetClass(), targetMethod, CharBeanSetter.class);
    }
