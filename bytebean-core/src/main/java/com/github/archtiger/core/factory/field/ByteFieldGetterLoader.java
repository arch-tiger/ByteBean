...
import com.github.archtiger.definition.invoker.field.ByteFieldGetter;
 ...
 * @datetime 2026/1/8
 */
public final class ByteFieldGetterLoader extends AbstractInvokerLoader<ByteFieldGetter> {
    private final Field targetField;

    public ByteFieldGetterLoader(Class<?> targetClass, Field targetField) {
        super(targetClass);
