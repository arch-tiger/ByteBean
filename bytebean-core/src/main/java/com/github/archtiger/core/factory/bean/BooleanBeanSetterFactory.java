...
import com.github.archtiger.core.invoke.bean.BooleanBeanSetter;
...
/**
 * BooleanBeanSetter 工厂
 *
 * @author ZIJIDELU
 * @datetime 2026/1/7
 */
public final class BooleanBeanSetterFactory extends AbstractInvokerFactory<BooleanBeanSetter> {
    private final Method targetMethod;

    public BooleanBeanSetterFactory(Class<?> targetClass, Method targetMethod) {
        super(targetClass);
        this.targetMethod = targetMethod;
    }

    @Override
    protected Class<BooleanBeanSetter> defineInvokerClass() {
        return BooleanBeanSetter.class;
    }

    @Override
    protected InvokerNameInfo defineInvokerName() {
        return InvokerNameInfo.forMethod(getTargetClass(), targetMethod, BooleanBeanSetter.class);
    }
