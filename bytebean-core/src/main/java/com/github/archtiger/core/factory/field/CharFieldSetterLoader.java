 ...
 * @datetime 2026/1/8
 */
public final class CharFieldSetterLoader extends AbstractInvokerLoader<CharFieldSetter> {
    private final Field targetField;

    public CharFieldSetterLoader(Class<?> targetClass, Field targetField) {
        super(targetClass);
        this.targetField = targetField;
    }

    @Override
    protected Class<CharFieldSetter> getInvokerClass() {
