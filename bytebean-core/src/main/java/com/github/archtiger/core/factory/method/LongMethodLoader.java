...
import com.github.archtiger.definition.invoker.method.LongMethod;
 ...
 * @datetime 2026/1/9
 */
public final class LongMethodLoader extends AbstractInvokerLoader<LongMethod> {
    private final Method targetMethod;

    public LongMethodLoader(Class<?> targetClass, Method targetMethod) {
        super(targetClass);
        this.targetMethod = targetMethod;
    }

    @Override
    protected Class<LongMethod> defineInvokerClass() {
        return LongMethod.class;
    }

    @Override
    protected InvokerNameInfo defineInvokerName() {
        return InvokerNameInfo.forMethod(getTargetClass(), targetMethod, LongMethod.class);
    }
