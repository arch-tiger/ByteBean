...
import com.github.archtiger.core.invoke.field.CharFieldGetter;
 ...
 * @datetime 2026/1/8
 */
public final class CharFieldGetterFactory extends AbstractInvokerFactory<CharFieldGetter> {
    private final Field targetField;

    public CharFieldGetterFactory(Class<?> targetClass, Field targetField) {
        super(targetClass);
