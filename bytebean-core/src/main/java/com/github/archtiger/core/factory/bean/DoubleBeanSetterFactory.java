...
import com.github.archtiger.core.invoke.bean.DoubleBeanSetter;
 ...
 * @datetime 2026/1/7
 */
public final class DoubleBeanSetterFactory extends AbstractInvokerFactory<DoubleBeanSetter> {
    private final Method targetMethod;

    public DoubleBeanSetterFactory(Class<?> targetClass, Method targetMethod) {
        super(targetClass);
        this.targetMethod = targetMethod;
    }

    @Override
    protected Class<DoubleBeanSetter> defineInvokerClass() {
        return DoubleBeanSetter.class;
    }

    @Override
    protected InvokerNameInfo defineInvokerName() {
        return InvokerNameInfo.forMethod(getTargetClass(), targetMethod, DoubleBeanSetter.class);
    }
