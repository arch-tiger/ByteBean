...
import com.github.archtiger.core.invoke.bean.ByteBeanSetter;
 ...
 * @datetime 2026/1/7
 */
public final class ByteBeanSetterFactory extends AbstractInvokerFactory<ByteBeanSetter> {
    private final Method targetMethod;

    public ByteBeanSetterFactory(Class<?> targetClass, Method targetMethod) {
        super(targetClass);
        this.targetMethod = targetMethod;
    }

    @Override
    protected Class<ByteBeanSetter> defineInvokerClass() {
        return ByteBeanSetter.class;
    }

    @Override
    protected InvokerNameInfo defineInvokerName() {
        return InvokerNameInfo.forMethod(getTargetClass(), targetMethod, ByteBeanSetter.class);
    }
