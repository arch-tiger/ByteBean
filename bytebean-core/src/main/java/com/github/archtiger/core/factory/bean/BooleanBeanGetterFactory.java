...
import com.github.archtiger.core.invoke.bean.BooleanBeanGetter;
...
/**
 * BooleanBeanGetter 工厂
 *
 * @author ZIJIDELU
 * @datetime 2026/1/7
 */
public final class BooleanBeanGetterFactory extends AbstractInvokerFactory<BooleanBeanGetter> {
    private final Method targetMethod;

    public BooleanBeanGetterFactory(Class<?> targetClass, Method targetMethod) {
        super(targetClass);
        this.targetMethod = targetMethod;
    }

    @Override
    protected Class<BooleanBeanGetter> defineInvokerClass() {
        return BooleanBeanGetter.class;
    }

    @Override
    protected InvokerNameInfo defineInvokerName() {
        return InvokerNameInfo.forMethod(getTargetClass(), targetMethod, BooleanBeanGetter.class);
    }
