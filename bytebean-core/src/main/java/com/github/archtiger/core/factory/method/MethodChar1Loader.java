...
public final class MethodChar1Loader extends AbstractInvokerLoader<MethodChar1> {
    ...
    @Override
    protected Class<MethodChar1> getInvokerClass() {
    ...
    protected ByteCodeAppender getByteCodeAppender() {
        return new MethodPrimitive1InvokerAppender(new InvokerInfo(getTargetClass(), getInvokerClass(), char.class), targetMethod);
    }
