...
/**
 * Double MethodInvoker 工厂
 *
 * @author ZIJIDELU
 * @datetime 2026/1/8
 */
public final class DoubleMethodInvokerFactory extends AbstractInvokerFactory<DoubleMethodInvoker> {
    private final Method targetMethod;

    public DoubleMethodInvokerFactory(Class<?> targetClass, Method targetMethod) {
        super(targetClass);
