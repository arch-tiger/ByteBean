...
public class MethodP2ByteCode implements Implementation {
    ...
    public MethodP2ByteCode(Class<?> targetClass, List<Method> methods) {
    ...
    public ByteCodeAppender appender(Target implementationTarget) {
        return (mv, implementationContext, instrumentedMethod) -> {
            ...
            // 注意：Slot 3, 4 被 arg1, arg2 占用，所以这里必须存入 Slot 5
            // ============================================================
            mv.visitVarInsn(Opcodes.ALOAD, 2); // Slot 2: Object instance
            mv.visitTypeInsn(Opcodes.CHECKCAST, owner);
            mv.visitVarInsn(Opcodes.ASTORE, 5); // Slot 5: TargetClass instance (Casted)
            ...
            for (int i = 0; i < methods.size(); i++) {
                ...
                // A: 【优化】直接从 Slot 5 加载已强转的 instance
