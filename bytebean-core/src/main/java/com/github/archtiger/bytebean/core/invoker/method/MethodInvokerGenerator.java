    ...
    public static MethodInvokerResult generate(Class<?> targetClass) {
        return CACHE.computeIfAbsent(targetClass, k -> {
            ...
            Class<? extends MethodInvoker> invokerClass = new ByteBuddy()
                    ...
                    // 定义 invoke 方法: Object invoke(int index, Object instance, Object arg0, Object arg1)
                    ...
                    .intercept(new MethodP2ByteCode(targetClass, methods))
                    // 定义 invoke 方法: Object invoke(int index, Object instance, Object arg0, Object arg1, Object arg2)
                    ...
                    .intercept(new MethodP3ByteCode(targetClass, methods))
                    // 定义 invoke 方法: Object invoke(int index, Object instance, Object arg0, Object arg1, Object arg2, Object arg3)
                    ...
                    .intercept(new MethodP4ByteCode(targetClass, methods))
                    // 定义 invoke 方法: Object invoke(int index, Object instance, Object arg0, Object arg1, Object arg2, Object arg3, Object arg4)
                    ...
                    .intercept(new MethodP5ByteCode(targetClass, methods))
                    // 基本类型返回方法
