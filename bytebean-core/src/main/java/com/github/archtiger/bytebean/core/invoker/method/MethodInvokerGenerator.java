    ...
    public static MethodInvokerResult generate(Class<?> targetClass) {
        return CACHE.computeIfAbsent(targetClass, k -> {
            ...
            Class<? extends MethodInvoker> invokerClass = new ByteBuddy()
                    ...
                    .intercept(new MethodByteCode(targetClass, methodGroup.methodIdentifyList()))
                    ...
                    .withParameters(int.class, Object.class, Object[].class)
                    .intercept(new PrimitiveMethodByteCode(targetClass, methodGroup.methodIdentifyList(), int.class))
                    .defineMethod("longInvoke", long.class, Visibility.PUBLIC, MethodManifestation.FINAL)
                    .withParameters(int.class, Object.class, Object[].class)
                    .intercept(new PrimitiveMethodByteCode(targetClass, methodGroup.methodIdentifyList(), long.class))
                    .defineMethod("floatInvoke", float.class, Visibility.PUBLIC, MethodManifestation.FINAL)
                    .withParameters(int.class, Object.class, Object[].class)
                    .intercept(new PrimitiveMethodByteCode(targetClass, methodGroup.methodIdentifyList(), float.class))
                    .defineMethod("doubleInvoke", double.class, Visibility.PUBLIC, MethodManifestation.FINAL)
                    .withParameters(int.class, Object.class, Object[].class)
                    .intercept(new PrimitiveMethodByteCode(targetClass, methodGroup.methodIdentifyList(), double.class))
                    .defineMethod("booleanInvoke", boolean.class, Visibility.PUBLIC, MethodManifestation.FINAL)
                    .withParameters(int.class, Object.class, Object[].class)
                    .intercept(new PrimitiveMethodByteCode(targetClass, methodGroup.methodIdentifyList(), boolean.class))
                    .defineMethod("byteInvoke", byte.class, Visibility.PUBLIC, MethodManifestation.FINAL)
                    .withParameters(int.class, Object.class, Object[].class)
                    .intercept(new PrimitiveMethodByteCode(targetClass, methodGroup.methodIdentifyList(), byte.class))
                    .defineMethod("shortInvoke", short.class, Visibility.PUBLIC, MethodManifestation.FINAL)
                    .withParameters(int.class, Object.class, Object[].class)
                    .intercept(new PrimitiveMethodByteCode(targetClass, methodGroup.methodIdentifyList(), short.class))
                    .defineMethod("charInvoke", char.class, Visibility.PUBLIC, MethodManifestation.FINAL)
                    .withParameters(int.class, Object.class, Object[].class)
                    .intercept(new PrimitiveMethodByteCode(targetClass, methodGroup.methodIdentifyList(), char.class))
                    // 单参数基本类型方法
                    ...
                    .intercept(new MethodPrimitiveP1ByteCode(targetClass, methodGroup.methodIdentifyList(), int.class))
                    ...
                    .intercept(new MethodPrimitiveP1ByteCode(targetClass, methodGroup.methodIdentifyList(), long.class))
                    ...
                    .intercept(new MethodPrimitiveP1ByteCode(targetClass, methodGroup.methodIdentifyList(), float.class))
                    ...
                    .intercept(new MethodPrimitiveP1ByteCode(targetClass, methodGroup.methodIdentifyList(), double.class))
                    ...
                    .intercept(new MethodPrimitiveP1ByteCode(targetClass, methodGroup.methodIdentifyList(), boolean.class))
                    ...
                    .intercept(new MethodPrimitiveP1ByteCode(targetClass, methodGroup.methodIdentifyList(), byte.class))
                    ...
                    .intercept(new MethodPrimitiveP1ByteCode(targetClass, methodGroup.methodIdentifyList(), short.class))
                    ...
                    .intercept(new MethodPrimitiveP1ByteCode(targetClass, methodGroup.methodIdentifyList(), char.class))
                    // 自动计算
            ...
            return MethodInvokerResult.success(
                    invokerClass,
                    Collections.unmodifiableList(methodGroup.methodIdentifyList().stream().map(MethodIdentify::method).collect(Collectors.toList()))
            );
        });
